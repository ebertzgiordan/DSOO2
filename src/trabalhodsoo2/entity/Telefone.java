...
public class Telefone {
    ...
    public String toString() {
        return "Telefone{" + "id=" + id + ", codigo=" + codigo + ", localizacao=" + localizacao + ", ocupada=" + ocupada + ", usuarioFinal=" + usuarioFinal + ", observacao=" + observacao + ", tipo=" + tipo + ", tipoCabo=" + tipoCabo + ", uso=" + uso + ", ramal=" + ramal + ", corCabo=" + corCabo + ", porta=" + porta + ", rackId=" + rackId + ", patchPanelId=" + patchPanelId + '}';
    }
